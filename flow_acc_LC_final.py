# this file determines flow accumulation generated by degree-day melt and precipitation at the gauge and sites for Lemon Creek
...
w_filename_LC = '/data/stor/proj/keeya_thesis/LC_Glacier/data/raw_data/C17_met_data.txt' # USGS met data
r_filename_LC = '/data/stor/proj/keeya_thesis/LC_Glacier/data/raw_data/C17Rain_cleaned.txt' # UI Rain Gauge Record
s_filename_LC = '/data/stor/proj/keeya_thesis/LC_Glacier/data/raw_data/snow_line_final.xlsx' # snowline elevation file from modified glacee 
